...
const loginDoctor = async (req, res) => {
  try {
    ...
    if (!user) {
      return res.json({ success: false, message: "Doctor not found. Invalid credentials." });
    }
...
const updateDoctorProfile = async (req, res) => {
    try {
        ...
        await doctorModel.findByIdAndUpdate(docId, { fees, address, available, latitude, longitude })
